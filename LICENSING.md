...
A `LICENSE-etherpad` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [ether/etherpad-lite](https://github.com/ether/etherpad-lite), Copyright
2013 THE ETHERPAD FOUNDATION, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../etherpad-port/specs/SPEC-001-etherpad.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
